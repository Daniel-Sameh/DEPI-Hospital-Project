      ...
      <div className="container">
        ...
        <div className="row justify-content-center" id={styles.specialty}>
          <div className={`col-lg-6 col-md-6 col-sm-12 col-xs-12 ${styles.specialtyDetails}`}>
            ...
            <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Repellat excepturi laboriosam sequi placeat possimus maxime nam est, rerum optio ipsa quam eius, aliquam, veritatis pariatur modi cum nobis! Laboriosam, expedita.
              Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quibusdam nobis error omnis, voluptatem harum hic sequi ipsam molestias provident dolor quas deleniti repellat laboriosam iusto aut! Sint veritatis id illo.
            </p>
            <div className="row">
            ...
            <a href="#book-appointment" onClick={handleClick}>Appointment Now <FontAwesomeIcon icon={faAngleDoubleRight}/></a>
          </div>
